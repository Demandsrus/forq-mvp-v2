...
const dishes: Dish[] = [
  ...
  },
  {
    ...
    taste: { sweet_savory: 0.4, herby_umami: 0.8, crunchy_soft: 0.2 },
    url: 'https://example.com/stuffed-grape-leaves',
    image_url: 'https://images.unsplash.com/photo-1571197119282-7c4e2b8b3d8e?w=400'
  },
  {
    name: 'Baba Ganoush',
    ...
    allergens: ['sesame'],
    spice: 1,
    macros: { kcal: 160, protein: 4, carbs: 12, fat: 12 },
    taste: { sweet_savory: 0.2, herby_umami: 0.8, crunchy_soft: 0.1 },
    url: 'https://example.com/baba-ganoush',
    image_url: 'https://images.unsplash.com/photo-1571197119282-7c4e2b8b3d8e?w=400'
  },
  {
    ...
    allergens: ['dairy'],
    spice: 1,
    macros: { kcal: 380, protein: 16, carbs: 45, fat: 14 },
    taste: { sweet_savory: 0.3, herby_umami: 0.7, crunchy_soft: 0.5 },
    url: 'https://example.com/mediterranean-quinoa-bowl',
    image_url: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400'
  },
  {
    name: 'Moussaka',
    ...
    allergens: ['gluten', 'dairy', 'eggs'],
    spice: 1,
    macros: { kcal: 450, protein: 20, carbs: 35, fat: 26 },
    taste: { sweet_savory: 0.5, herby_umami: 0.8, crunchy_soft: 0.3 },
    url: 'https://example.com/moussaka',
    image_url: 'https://images.unsplash.com/photo-1571197119282-7c4e2b8b3d8e?w=400'
  },
  ...
  },
  {
    ...
    allergens: [],
    spice: 1,
    macros: { kcal: 420, protein: 38, carbs: 12, fat: 24 },
    taste: { sweet_savory: 0.4, herby_umami: 0.9, crunchy_soft: 0.2 },
  ...
  },
  {
    ...
    allergens: ['gluten', 'dairy', 'eggs'],
    spice: 0,
    macros: { kcal: 380, protein: 8, carbs: 35, fat: 24 },
    taste: { sweet_savory: 0.9, herby_umami: 0.2, crunchy_soft: 0.1 },
  ...
  },
  {
    ...
    allergens: ['gluten', 'dairy', 'eggs'],
    spice: 1,
    macros: { kcal: 380, protein: 15, carbs: 42, fat: 18 },
    taste: { sweet_savory: 0.5, herby_umami: 0.5, crunchy_soft: 0.8 },
    url: 'https://example.com/korean-corn-dogs',
    image_url: 'https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=400'
  },
  {
    name: 'Sundubu Jjigae',
    ...
    allergens: ['soy'],
    spice: 4,
    macros: { kcal: 220, protein: 16, carbs: 12, fat: 12 },
    taste: { sweet_savory: 0.3, herby_umami: 0.9, crunchy_soft: 0.1 },
    url: 'https://example.com/sundubu-jjigae',
    image_url: 'https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=400'
  },
  {
    ...
    spice: 2,
    macros: { kcal: 280, protein: 8, carbs: 38, fat: 10 },
    taste: { sweet_savory: 0.4, herby_umami: 0.7, crunchy_soft: 0.7 },
    url: 'https://example.com/korean-pancakes',
    image_url: 'https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=400'
  },
  {
    name: 'Galbi',
  ...
  },
  {
    ...
    allergens: ['dairy'],
    spice: 1,
    macros: { kcal: 480, protein: 35, carbs: 25, fat: 28 },
    taste: { sweet_savory: 0.4, herby_umami: 0.8, crunchy_soft: 0.2 },
    url: 'https://example.com/mansaf',
    image_url: 'https://images.unsplash.com/photo-1529042410759-befb1204b468?w=400'
  },
  {
    name: 'Kibbeh',
    ...
    allergens: ['gluten'],
    spice: 2,
    macros: { kcal: 320, protein: 18, carbs: 28, fat: 16 },
    taste: { sweet_savory: 0.4, herby_umami: 0.7, crunchy_soft: 0.7 },
    url: 'https://example.com/kibbeh',
    image_url: 'https://images.unsplash.com/photo-1529042410759-befb1204b468?w=400'
  },
  {
    name: 'Muhammara',
    ...
    allergens: ['tree_nuts'],
    spice: 3,
    macros: { kcal: 220, protein: 6, carbs: 18, fat: 16 },
    taste: { sweet_savory: 0.5, herby_umami: 0.7, crunchy_soft: 0.3 },
    url: 'https://example.com/muhammara',
    image_url: 'https://images.unsplash.com/photo-1571197119282-7c4e2b8b3d8e?w=400'
  },
  {
    name: 'Labneh',
    ...
    allergens: ['dairy'],
    spice: 0,
    macros: { kcal: 120, protein: 8, carbs: 6, fat: 8 },
    taste: { sweet_savory: 0.2, herby_umami: 0.6, crunchy_soft: 0.1 },
    url: 'https://example.com/labneh',
    image_url: 'https://images.unsplash.com/photo-1571197119282-7c4e2b8b3d8e?w=400'
  },
  {
    name: 'Mujadara',
    ...
    allergens: [],
    spice: 1,
    macros: { kcal: 280, protein: 14, carbs: 48, fat: 6 },
    taste: { sweet_savory: 0.4, herby_umami: 0.7, crunchy_soft: 0.2 },
  ...
  },
  {
    ...
    allergens: ['peanuts'],
    spice: 2,
    macros: { kcal: 380, protein: 18, carbs: 52, fat: 10 },
    taste: { sweet_savory: 0.4, herby_umami: 0.7, crunchy_soft: 0.6 },
    url: 'https://example.com/vermicelli-bowl',
    image_url: 'https://images.unsplash.com/photo-1569562211093-4ed0d0758f12?w=400'
  },
  {
    name: 'Cao Lau',
    ...
    allergens: ['gluten', 'soy'],
    spice: 1,
    macros: { kcal: 350, protein: 16, carbs: 48, fat: 10 },
    taste: { sweet_savory: 0.4, herby_umami: 0.8, crunchy_soft: 0.5 },
    url: 'https://example.com/cao-lau',
    image_url: 'https://images.unsplash.com/photo-1569562211093-4ed0d0758f12?w=400'
  },
  {
    name: 'Goi Cuon',
    ...
    allergens: ['shellfish'],
    spice: 0,
    macros: { kcal: 120, protein: 8, carbs: 18, fat: 2 },
    taste: { sweet_savory: 0.3, herby_umami: 0.6, crunchy_soft: 0.4 },
    url: 'https://example.com/goi-cuon',
    image_url: 'https://images.unsplash.com/photo-1569562211093-4ed0d0758f12?w=400'
  },
  {
    name: 'Com Tam',
    ...
    allergens: ['eggs'],
    spice: 1,
    macros: { kcal: 420, protein: 25, carbs: 55, fat: 12 },
    taste: { sweet_savory: 0.5, herby_umami: 0.7, crunchy_soft: 0.4 },
    url: 'https://example.com/com-tam',
    image_url: 'https://images.unsplash.com/photo-1569562211093-4ed0d0758f12?w=400'
  },
  {
    name: 'Che Ba Mau',
    ...
    allergens: [],
    spice: 0,
    macros: { kcal: 280, protein: 4, carbs: 58, fat: 6 },
    taste: { sweet_savory: 0.9, herby_umami: 0.1, crunchy_soft: 0.3 },
    url: 'https://example.com/che-ba-mau',
    image_url: 'https://images.unsplash.com/photo-1569562211093-4ed0d0758f12?w=400'
  },
  ...
  },
  {
    ...
    allergens: ['eggs'],
    spice: 0,
    macros: { kcal: 150, protein: 2, carbs: 12, fat: 12 },
    taste: { sweet_savory: 0.6, herby_umami: 0.2, crunchy_soft: 0.9 },
    url: 'https://example.com/coleslaw',
    image_url: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400'
  },
  {
    name: 'Pancakes',
  ...
  },
  {
    ...
    allergens: ['gluten', 'dairy'],
    spice: 0,
    macros: { kcal: 280, protein: 10, carbs: 38, fat: 12 },
    taste: { sweet_savory: 0.3, herby_umami: 0.7, crunchy_soft: 0.5 },
    url: 'https://example.com/greek-orzo-salad',
    image_url: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400'
  },
  {
    name: 'Pastitsio',
    ...
    allergens: ['gluten', 'dairy', 'eggs'],
    spice: 1,
    macros: { kcal: 520, protein: 28, carbs: 45, fat: 26 },
    taste: { sweet_savory: 0.4, herby_umami: 0.8, crunchy_soft: 0.3 },
    url: 'https://example.com/pastitsio',
    image_url: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400'
  },
  {
    ...
    macros: { kcal: 220, protein: 12, carbs: 18, fat: 12 },
    taste: { sweet_savory: 0.3, herby_umami: 0.7, crunchy_soft: 0.1 },
    url: 'https://example.com/avgolemono-soup',
    image_url: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400'
  },
  {
    name: 'Greek Honey Cookies',
    cuisine: 'Greek',
    diet_tags: ['vegetarian'],
    allergens: ['gluten', 'dairy', 'eggs', 'tree_nuts'],
    spice: 0,
    macros: { kcal: 180, protein: 3, carbs: 28, fat: 8 },
    taste: { sweet_savory: 0.9, herby_umami: 0.1, crunchy_soft: 0.8 },
    url: 'https://example.com/greek-honey-cookies',
    image_url: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400'
  },
  {
    ...
    allergens: [],
    spice: 1,
    macros: { kcal: 280, protein: 25, carbs: 8, fat: 16 },
    taste: { sweet_savory: 0.2, herby_umami: 0.9, crunchy_soft: 0.6 },
    url: 'https://example.com/grilled-octopus',
    image_url: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400'
  }
]
